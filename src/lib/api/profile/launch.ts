...
export const launchGame = (vanilla: boolean, args?: string) =>
	invoke('launch_game', { vanilla, args });
export const launchServer = (vanilla: boolean, args?: string) =>
	invoke('launch_server', { vanilla, args });
