...
<Popup bind:open title="Import profiles from r2modman" canClose={!importing}>
  <div class="text-slate-300">
    <p>
      This will import cached mods and profiles <b>for the current game</b> from r2modman. 
      The process may take a couple of minutes, depending on how many mods and profiles there are to import.
      <b>Profiles with the same name will be overwritten!</b>
    </p>
  
    <p class="mt-2">
      Please do not close Gale while the import is in progress.
    </p>
  </div>
...
{#if message}
  <div class="flex items-center bottom-2 right-2 left-2 rounded-lg p-2 absolute z-10 bg-gray-800 
