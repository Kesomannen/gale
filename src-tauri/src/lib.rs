...
pub fn run() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            profile::commands::get_active_profile_settings,
            profile::commands::get_profile_settings,
            profile::commands::set_active_profile_settings,
            profile::commands::set_profile_settings,
